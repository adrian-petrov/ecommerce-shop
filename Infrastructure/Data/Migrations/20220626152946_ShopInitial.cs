        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    BuyerId = table.Column<string>(type: "varchar(255) CHARACTER SET utf8mb4", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    BuyerEmail = table.Column<string>(type: "varchar(255) CHARACTER SET utf8mb4", nullable: true),
                    OrderDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    DeliveryAddress_FirstName = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    DeliveryAddress_LastName = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    DeliveryAddress_Street1 = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    DeliveryAddress_Street2 = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    DeliveryAddress_Town = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    DeliveryAddress_County = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    DeliveryAddress_Postcode = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Brand = table.Column<string>(type: "varchar(70) CHARACTER SET utf8mb4", maxLength: 70, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Street1 = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    Street2 = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    Town = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    County = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReasonRevoked = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ItemOrdered_ProductVariationId = table.Column<int>(type: "int", nullable: true),
                    ItemOrdered_ProductVariatingString = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>(type: "varchar(25) CHARACTER SET utf8mb4", maxLength: 25, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Sku = table.Column<string>(type: "varchar(80) CHARACTER SET utf8mb4", maxLength: 80, nullable: false),
                    VariationString = table.Column<string>(type: "varchar(120) CHARACTER SET utf8mb4", maxLength: 120, nullable: false),
                    Price = table.Column<decimal>(type: "decimal(6,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BasketItems_ProductVariations_ProductVariationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductsStock_ProductVariations_ProductVariationId",
                        column: x => x.ProductVariationId,
                        principalTable: "ProductVariations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductVariationImages_ProductVariations_ProductVariationId",
                        column: x => x.ProductVariationId,
                        principalTable: "ProductVariations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasketItems_ProductVariationId_BasketId",
                table: "BasketItems",
                columns: new[] { "ProductVariationId", "BasketId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsStock_ProductVariationId",
                table: "ProductsStock",
